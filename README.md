[![CodeQL](https://github.com/Chema22R/eslint-config/actions/workflows/codeql.yml/badge.svg)](https://github.com/Chema22R/eslint-config/actions/workflows/codeql.yml)
